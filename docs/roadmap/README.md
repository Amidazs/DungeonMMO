...
**v2.95 HUMAN WIZARD EXACT SOURCE COMBAT GREEN:** [roadmap](
...
Dungeon **19/19 PASS**, executor **13 assertions PASS**. Next: source-ready C4 NPC stat boundary, then the controlled dispatch adapter.
