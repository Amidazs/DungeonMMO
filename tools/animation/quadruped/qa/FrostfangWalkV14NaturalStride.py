...
OUTPUT = ROOT / "WalkV14_NaturalStride"
DESTINATION = OUTPUT / "Frostfang_WalkV14_UNAPPROVED.blend"
FINAL_FRAME = 72
WALK_START = 17
WALK_STOP = 65
CYCLE_FRAMES = 24
...
def main():
    ...
    if DESTINATION.exists():
        raise FileExistsError("WalkV14 already exists: " + str(DESTINATION))
    ...
    (OUTPUT / "walk_v14_manifest.json").write_text(
        json.dumps(report, indent=2), encoding="utf-8"
    )
    print("WALK_V14_SAVED", DESTINATION, flush=True)
