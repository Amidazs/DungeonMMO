...
ROOT = (
    ...
    "GroundedWalkTrial_20260923" / "WalkV10_ReachAwareShoulders" / "preview" / "full"
)
FRAMES = tuple(range(1, 73, 2)) + (72,)
FRAME_DURATION_MS = 83
OUTPUT = ROOT.parent / "Frostfang_WalkV10_Review_UNAPPROVED.gif"
...
def render_path(view, frame):
    ...
    """
    destination = ROOT / f"Frostfang_WalkV10_{view}_{frame:03d}.png"
...
def make_frame(frame):
    ...
    draw.text(
        (10, 8), "FROSTFANG / WALK V10 / UNAPPROVED QA",
        fill=(235, 235, 235),
    )
...
def main():
    ...
    print(
        "WALK_V10_GIF_SAVED", destination, size,
