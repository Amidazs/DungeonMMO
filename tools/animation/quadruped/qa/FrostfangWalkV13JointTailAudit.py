"""Measure real foreleg articulation and tail skinning in WalkV13.
...
SOURCE = (
    ROOT / "WalkV13_ScapularGlide" / "Frostfang_WalkV13_UNAPPROVED.blend"
)
FORELEGS = {
    "left": (
...
def main():
    ...
    print("WALK_V13_JOINT_TAIL_AUDIT", json.dumps(report), flush=True)
