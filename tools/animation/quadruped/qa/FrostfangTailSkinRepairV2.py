...
OUTPUT = ROOT / "RigFunctionQA_20260923" / "TailRepairV2"
...
def main():
    ...
    destination = OUTPUT / "Frostfang_TailSkinV2_UNAPPROVED.blend"
    ...
    (OUTPUT / "tail_skin_v2_audit.json").write_text(
        json.dumps(report, indent=2), encoding="utf-8"
    )
    print("TAIL_SKIN_V2", json.dumps(report), flush=True)
