"""Audit deformed Frostfang toe geometry during the walk-v8 trial.
...
ROOT = (
    ...
    "GroundedWalkTrial_20260923" / "WalkV10_ReachAwareShoulders"
)
SOURCE = ROOT / "Frostfang_WalkV10_UNAPPROVED.blend"
GROUP_NAMES = {
...
def main():
    ...
    destination = ROOT / "walk_v10_actual_mesh_audit.json"
    destination.write_text(
        json.dumps(report, indent=2), encoding="utf-8"
    )
    print("WALK_V10_MESH_SUMMARY", json.dumps(maxima), flush=True)
    print("WALK_V10_STANCE", json.dumps(stance), flush=True)
    print("WALK_V10_AUDIT_SAVED", destination, flush=True)
