...
ROOT = (
    ...
    "GroundedWalkTrial_20260923" / "WalkV16_PawPadGait"
)
SOURCE = ROOT / "Frostfang_WalkV16_UNAPPROVED.blend"
GROUP_NAMES = {
...
def main():
    ...
    destination = ROOT / "walk_v16_actual_mesh_audit.json"
    destination.write_text(
        json.dumps(report, indent=2), encoding="utf-8"
    )
    print("WALK_V16_MESH_SUMMARY", json.dumps(maxima), flush=True)
    print("WALK_V16_STANCE", json.dumps(stance), flush=True)
    print("WALK_V16_AUDIT_SAVED", destination, flush=True)
