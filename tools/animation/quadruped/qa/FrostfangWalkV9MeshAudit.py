...
ROOT = (
    ...
    "GroundedWalkTrial_20260923" / "WalkV9_ShoulderGait"
)
SOURCE = ROOT / "Frostfang_WalkV9_UNAPPROVED.blend"
GROUP_NAMES = {
...
def main():
    ...
    destination = ROOT / "walk_v9_actual_mesh_audit.json"
    destination.write_text(
        json.dumps(report, indent=2), encoding="utf-8"
    )
    print("WALK_V9_MESH_SUMMARY", json.dumps(maxima), flush=True)
    print("WALK_V9_STANCE", json.dumps(stance), flush=True)
    print("WALK_V9_AUDIT_SAVED", destination, flush=True)
