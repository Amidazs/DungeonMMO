"""Measure real foreleg articulation and tail skinning in WalkV12.
...
SOURCE = (
    ROOT / "WalkV12_WeightShift" / "Frostfang_WalkV12_UNAPPROVED.blend"
)
FORELEGS = {
    "left": (
...
def main():
    ...
    print("WALK_V12_JOINT_TAIL_AUDIT", json.dumps(report), flush=True)
