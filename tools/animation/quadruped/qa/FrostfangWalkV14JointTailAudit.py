"""Measure real foreleg articulation and tail skinning in WalkV14.
...
SOURCE = (
    ROOT / "WalkV14_NaturalStride" / "Frostfang_WalkV14_UNAPPROVED.blend"
)
FORELEGS = {
    "left": (
...
def main():
    ...
    print("WALK_V14_JOINT_TAIL_AUDIT", json.dumps(report), flush=True)
