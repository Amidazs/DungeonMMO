"""Assemble the real-mesh Frostfang walk-v6 QA renders into a GIF.
...
ROOT = (
    ...
    "GroundedWalkTrial_20260923" / "WalkV7_TailIsolation" / "preview" / "full"
)
FRAMES = tuple(range(1, 73, 2)) + (72,)
FRAME_DURATION_MS = 83
OUTPUT = ROOT.parent / "Frostfang_WalkV7_Tail_Review_UNAPPROVED.gif"
...
def render_path(view, frame):
    ...
    """
    destination = ROOT / f"Frostfang_WalkV7_Tail_{view}_{frame:03d}.png"
...
def make_frame(frame):
    ...
    draw.text(
        (10, 8), "FROSTFANG / WALK V7 TAIL / UNAPPROVED QA",
        fill=(235, 235, 235),
    )
...
def main():
    ...
    print(
        "WALK_V7_TAIL_GIF_SAVED", destination, size,
