...
SOURCE = (
    ROOT / "RigFunctionQA_20260923" / "TailRepairV1" /
    "Frostfang_TailSkinV1_UNAPPROVED.blend"
)
OUTPUT = ROOT / "RigFunctionQA_20260923" / "TailRepairV1" / "pose_review"
...
def main():
    ...
    blend = OUTPUT / "Frostfang_TailSkinV1_Poses_UNAPPROVED.blend"
    scene.frame_set(1)
    ...
    (OUTPUT / "tail_skin_v1_pose_audit.json").write_text(
