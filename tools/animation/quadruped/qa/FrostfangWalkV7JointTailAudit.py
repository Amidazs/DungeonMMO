"""Measure real foreleg articulation and tail skinning in WalkV7.
...
SOURCE = (
    ROOT / "WalkV7_Foreleg" / "Frostfang_WalkV7_Foreleg_UNAPPROVED.blend"
)
FORELEGS = {
    "left": (
...
def main():
    ...
    print("WALK_V7_JOINT_TAIL_AUDIT", json.dumps(report), flush=True)
