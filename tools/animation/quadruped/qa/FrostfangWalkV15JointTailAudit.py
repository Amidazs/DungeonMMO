"""Measure real foreleg articulation and tail skinning in WalkV15.
...
SOURCE = (
    ROOT / "WalkV15_SupportedStride" / "Frostfang_WalkV15_UNAPPROVED.blend"
)
FORELEGS = {
    "left": (
...
def main():
    ...
    print("WALK_V15_JOINT_TAIL_AUDIT", json.dumps(report), flush=True)
