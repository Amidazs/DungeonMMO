...
ROOT = (
    ...
    "GroundedWalkTrial_20260923" / "WalkV15_SupportedStride"
)
SOURCE = ROOT / "Frostfang_WalkV15_UNAPPROVED.blend"
GROUP_NAMES = {
...
def main():
    ...
    destination = ROOT / "walk_v15_actual_mesh_audit.json"
    destination.write_text(
        json.dumps(report, indent=2), encoding="utf-8"
    )
    print("WALK_V15_MESH_SUMMARY", json.dumps(maxima), flush=True)
    print("WALK_V15_STANCE", json.dumps(stance), flush=True)
    print("WALK_V15_AUDIT_SAVED", destination, flush=True)
