"""Measure real foreleg articulation and tail skinning in WalkV10.
...
SOURCE = (
    ROOT / "WalkV10_ReachAwareShoulders" / "Frostfang_WalkV10_UNAPPROVED.blend"
)
FORELEGS = {
    "left": (
...
def main():
    ...
    print("WALK_V10_JOINT_TAIL_AUDIT", json.dumps(report), flush=True)
