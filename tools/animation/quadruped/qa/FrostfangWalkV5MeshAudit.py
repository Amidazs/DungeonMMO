"""Audit deformed Frostfang toe geometry during the walk-v5 trial.
...
def main():
    ...
    destination = ROOT / "walk_v5_actual_mesh_audit.json"
    destination.write_text(
        json.dumps(report, indent=2), encoding="utf-8"
    )
    print("WALK_V5_MESH_SUMMARY", json.dumps(maxima), flush=True)
    print("WALK_V5_STANCE", json.dumps(stance), flush=True)
    print("WALK_V5_AUDIT_SAVED", destination, flush=True)
