...
ROOT = (
    ...
    "GroundedWalkTrial_20260923" / "WalkV12_WeightShift"
)
SOURCE = ROOT / "Frostfang_WalkV12_UNAPPROVED.blend"
GROUP_NAMES = {
...
def main():
    ...
    destination = ROOT / "walk_v12_actual_mesh_audit.json"
    destination.write_text(
        json.dumps(report, indent=2), encoding="utf-8"
    )
    print("WALK_V12_MESH_SUMMARY", json.dumps(maxima), flush=True)
    print("WALK_V12_STANCE", json.dumps(stance), flush=True)
    print("WALK_V12_AUDIT_SAVED", destination, flush=True)
