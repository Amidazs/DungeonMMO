...
OUTPUT = ROOT / "RigFunctionQA_20260923" / "TailRepairV3_Tip" / "pose_review"
...
def main():
    ...
    blend = OUTPUT / "Frostfang_TailSkinV3_Tip_Poses_UNAPPROVED.blend"
    scene.frame_set(1)
    ...
    (OUTPUT / "tail_skin_v3_tip_pose_audit.json").write_text(
