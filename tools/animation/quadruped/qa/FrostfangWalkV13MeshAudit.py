...
ROOT = (
    ...
    "GroundedWalkTrial_20260923" / "WalkV13_ScapularGlide"
)
SOURCE = ROOT / "Frostfang_WalkV13_UNAPPROVED.blend"
GROUP_NAMES = {
...
def main():
    ...
    destination = ROOT / "walk_v13_actual_mesh_audit.json"
    destination.write_text(
        json.dumps(report, indent=2), encoding="utf-8"
    )
    print("WALK_V13_MESH_SUMMARY", json.dumps(maxima), flush=True)
    print("WALK_V13_STANCE", json.dumps(stance), flush=True)
    print("WALK_V13_AUDIT_SAVED", destination, flush=True)
