...
ROOT = (
    ...
    "GroundedWalkTrial_20260923" / "WalkV14_NaturalStride"
)
SOURCE = ROOT / "Frostfang_WalkV14_UNAPPROVED.blend"
GROUP_NAMES = {
...
def main():
    ...
    destination = ROOT / "walk_v14_actual_mesh_audit.json"
    destination.write_text(
        json.dumps(report, indent=2), encoding="utf-8"
    )
    print("WALK_V14_MESH_SUMMARY", json.dumps(maxima), flush=True)
    print("WALK_V14_STANCE", json.dumps(stance), flush=True)
    print("WALK_V14_AUDIT_SAVED", destination, flush=True)
