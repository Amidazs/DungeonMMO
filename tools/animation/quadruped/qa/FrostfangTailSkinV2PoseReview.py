...
SOURCE = (
    ROOT / "RigFunctionQA_20260923" / "TailRepairV2" /
    "Frostfang_TailSkinV2_UNAPPROVED.blend"
)
OUTPUT = ROOT / "RigFunctionQA_20260923" / "TailRepairV2" / "pose_review"
...
def main():
    ...
    blend = OUTPUT / "Frostfang_TailSkinV2_Poses_UNAPPROVED.blend"
    scene.frame_set(1)
    ...
    (OUTPUT / "tail_skin_v2_pose_audit.json").write_text(
