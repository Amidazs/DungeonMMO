"""Audit deformed Frostfang toe geometry during the walk-v6 trial.
...
SOURCE = ROOT / "Frostfang_WalkV6_UNAPPROVED.blend"
GROUP_NAMES = {
...
def main():
    ...
    destination = ROOT / "walk_v6_actual_mesh_audit.json"
    destination.write_text(
        json.dumps(report, indent=2), encoding="utf-8"
    )
    print("WALK_V6_MESH_SUMMARY", json.dumps(maxima), flush=True)
    print("WALK_V6_STANCE", json.dumps(stance), flush=True)
    print("WALK_V6_AUDIT_SAVED", destination, flush=True)
