"""Measure real foreleg articulation and tail skinning in WalkV9.
...
SOURCE = (
    ROOT / "WalkV9_ShoulderGait" / "Frostfang_WalkV9_UNAPPROVED.blend"
)
FORELEGS = {
    "left": (
...
def main():
    ...
    print("WALK_V9_JOINT_TAIL_AUDIT", json.dumps(report), flush=True)
