...
ROOT = (
    ...
    "GroundedWalkTrial_20260923" / "WalkV8_ForelegTail" / "preview" / "full"
)
FRAMES = tuple(range(1, 73, 2)) + (72,)
FRAME_DURATION_MS = 83
OUTPUT = ROOT.parent / "Frostfang_WalkV8_Review_UNAPPROVED.gif"
...
def render_path(view, frame):
    ...
    """
    destination = ROOT / f"Frostfang_WalkV8_{view}_{frame:03d}.png"
...
def make_frame(frame):
    ...
    draw.text(
        (10, 8), "FROSTFANG / WALK V8 / UNAPPROVED QA",
        fill=(235, 235, 235),
    )
...
def main():
    ...
    print(
        "WALK_V8_GIF_SAVED", destination, size,
